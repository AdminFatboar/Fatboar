...
<head>
    ...
    <title>Mentions Légales | Fatboar</title>
	<meta name="description" content="Les mentions légales de Fatboar sont créées afin de vous avertir des obligations légales sur Internet en France concernant le jeu-concours">
	...
	<div class="container mt-2 text-justify">
        <div class="row">
            <div class="col-12 my-3">
                <p>
                    La société Fatboar, soucieuse des droits des individus, notamment au regard des traitements automatisés, et dans une volonté de transparence avec ses clients, a mis en place une politique reprenant l’ensemble de ces traitements, des finalités poursuivies par ces derniers ainsi que des moyens d’actions à la disposition des individus afin qu’ils puissent au mieux exercer leurs droits.
                </p>

                <p>
                    Pour toute information complémentaire sur la protection des données personnelles, nous vous invitons à consulter le site :<a href="https://www.cnil.fr/"> CNIL</a>.
                </p>

                <p>
                    La poursuite de la navigation sur ce site vaut acceptation sans réserve des dispositions et conditions d'utilisation qui suivent. Vous acceptez l'utilisation de cookies et autres traceurs.
                </p>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <p>
                    <u>1.1 Site (ci-après « le site ») :</u> Fatboar
                </p>

                <p>
                    <u>1.2 Éditeur (ci-après « l'éditeur ») : </u> <br>
                    Fatboar SA, au capital de 750 000€,<br>
                    dont le siège social est situé: 1 bis Rue Gustave Eiffel, 78280 Guyancourt<br>
                    représentée Mr E. BOURDON, en sa qualité de directeur général,<br>
                    SIRET 77942658200013, <br>
                    n° de téléphone : +33146385656,<br>
                    adresse mail : support@fatboar.fr
                </p>

                <p>
                    <u>1.3 Hébergeur (ci-après « l'hébergeur ») :</u> <br>
                    Gusto coffee est hébergé par Scalway, dont le siège social est au 8 rue de la ville l’évêque 75008 Paris.
                </p>
                ...
                <h4>Article 7 - Collecte de données</h4>

                <p>
                    Vos données sont collectées par La société Fatboar.
                </p>
                <p>
                ...
                <h4>Article 8 - Droit d’accès, de rectification et de déréférencement de vos données</h4>

                <p>
                    Chaque personne dispose d’un droit d’accès, de rectification et d’opposition à ses données personnelles. Chaque personne dispose aussi du droit de limitation du traitement relatif à sa personne, du droit de déréférencement et du droit à la portabilité des données personnelles qu’elle a transmise au responsable de traitement.
                </p>
                <p>
                    Vous pouvez exercer ce droit en nous contactant, à l’adresse suivante : 1 bis rue Gustave Eiffel, 78280 Guyancourt. Ou par email à l’adresse support@fatboar.ovh.
                </p>
                <p>
                ...
                <h4>Article 9 - Utilisation des données</h4>
                ...
                <p>
                    En cas d'infraction de tout type, pour lesquelles les parties seraient mises en cause, et pour lesquelles les autorités judiciaires auraient besoin d'avoir connaissance des informations recueillies, ces dernières seront alors nécessairement communiquées à ces autorités sur leur demande expresse et motivée, et ne bénéficieront plus des dispositions relatives à la protection des données personnelles.
                </p>
                <p>
                ...
                <h4>Article 10 - Offres commerciales</h4>

                <p>
                    Vous êtes susceptible de recevoir des offres commerciales de l'éditeur.
                </p>
                <p>
                    Vos données sont susceptibles d’être utilisées par les partenaires de l'éditeur à des fins de prospection commerciale.
                </p>
                <p>
                ...
                <p>
                    Les cookies suivants sont présents sur ce site : Cookies de navigation, Cookies de performance. <br>
                    Leur finalité est la suivante : Ces cookies collectent des informations sur les modes d'utilisation des sites Internet par l'ensemble des visiteurs.<br>
                    Leur durée de vie est de treize mois.
                </p>
                <p>
                ...
                <h4>Article 12 - Photographies et représentation des produits</h4>
                ...
                <h4>Article 14 - Contactez-nous</h4>

                <p>
                    Pour toute question, information sur les produits présentés sur le site, ou concernant le site lui-même, vous pouvez laisser un message à l'adresse suivante : support@fatboar.fr.
                </p>
				<br>
            </div>
        </div>
